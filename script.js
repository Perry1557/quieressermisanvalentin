let noButtonClickCount = 0; // Counter for button "No"
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'Say yes and i will not be sad';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Ok, I will stop asking...';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 15:
            ...
            document.getElementById('noBtn').innerHTML = 'You Yesssssssssssssssssss';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'pleaseoooooo';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
